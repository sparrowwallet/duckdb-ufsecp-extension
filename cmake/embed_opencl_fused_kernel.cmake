...
foreach(FILE ${KERNEL_FILES})
    ...
    # Strip unused ECDSA SNARK witness code from secp256k1_extended.cl (reduces compilation time)
    string(FIND "${CONTENT}" "LAYER 6: ECDSA SNARK" SNARK_POS)
    if(NOT SNARK_POS EQUAL -1)
        string(SUBSTRING "${CONTENT}" 0 ${SNARK_POS} CONTENT)
    endif()
